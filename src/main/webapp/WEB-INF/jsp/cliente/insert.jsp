                ...
                <form:form modelAttribute="insert_cliente_attr" method="post" action="save" novalidate="novalidate" class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <spring:bind path="indirizzo">
                            <input type="text" class="form-control ${status.error ? 'is-invalid' : ''}" name="indirizzo" id="indirizzo" placeholder="Inserire il indirizzo" value="${insert_cliente_attr.indirizzo}" required>
                        </spring:bind>
