                        ...
                        <c:forEach items="${cliente_list_attribute }" var="clienteItem">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn  btn-sm btn-outline-primary ml-2 mr-2" href="da inserire">Edit</a>
                                    <a class="btn btn-outline-danger btn-sm" href="${pageContext.request.contextPath}/cliente/delete/${clienteItem.id}">Delete</a>
