            ...
            <div class='card-body'>
                ...
                <form method="post" action="${pageContext.request.contextPath}/pizza/list" class="row g-3" >
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="ingredienti" id="ingredienti" class="form-control" placeholder="Inserire gli ingrediente"  >
                    </div>
                    ...
                    <div class="col-md-6">
                        <label for="attivo" class="form-label">Stato Pizza</label>
                        <select class="form-select" name="attivo" id="attivo">
