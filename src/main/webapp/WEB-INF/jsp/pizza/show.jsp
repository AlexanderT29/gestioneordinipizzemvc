...
<main class="flex-shrink-0">
    <div class="container">
        ...
        <div class='card'>
            ...
            <div class='card-body'>
                ...
                <dl class="row">
                    ...
                    <dd class="col-sm-9">${show_pizza_attr.prezzo}</dd>
                </dl>

                <dl class = "row">
                    <dt class = "col-sm-3 text-right">Attiva:</dt>
                    <dd class="col-sm-9">${show_pizza_attr.attiva}</dd>
                </dl>
        ...
        <div class='card-footer'>
            <a href="${pageContext.request.contextPath }/pizza" class='btn btn-outline-puro' style='width:80px'>
